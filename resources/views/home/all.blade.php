...
@section('content')
    ...
    <div class="home_content">
        ...
        <div class="home_title">Всі друзі</div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="sorting_bar d-flex flex-md-row flex-column align-items-md-center justify-content-md-start">
						<div class="results">Показано результатів:  <span>{{$friends->count()}}</span></div>
						<div class="sorting_container ml-md-auto">
							<div class="sorting">
								<ul class="item_sorting">
									<li><span class="sorting_text">Сортувати за</span>
			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						<!-- Product -->
						<div class="product">
                            <a href="{{route('getFriends', ['all-friends', $friend->friend_id])}}">
                                <div class="product_image">
                                    <img src="images/{{$image}} "alt="{{$friend->friend_name}}">
                                </div>

                                <div class="product_content">
                                    <div class="product_title"><a href="{{route('getFriends', ['all-friends', $friend->friend_id])}}">{{$friend->friend_name}}</a></div>
                                    @php
                                        $age = " років";
